 ...
 * \file shortcut.h
 */
#ifndef NNVM_TOP_VISION_SHORTCUT_H_
#define NNVM_TOP_VISION_SHORTCUT_H_
...
template <typename AttrType, bool (*is_none)(const AttrType &),
          ...
          int n_out = -1>
inline bool
ShortcutAttr(const nnvm::NodeAttrs &attrs, std::vector<AttrType> *in_attrs,
...
inline bool ShortcutShape(const NodeAttrs &attrs, std::vector<TShape> *in_attrs,
  ...
  return ShortcutAttr<TShape, shape_is_none, shape_assign, true, shape_string>(
      attrs, in_attrs, out_attrs, TShape());
}

template <int n_in, int n_out>
inline bool ShortcutType(const NodeAttrs &attrs, std::vector<int> *in_attrs,
  ...
  return ShortcutAttr<int, type_is_none, type_assign, true, type_string>(
      attrs, in_attrs, out_attrs, -1);
}
}  // namespace top
}  // namespace nnvm
#endif  // NNVM_TOP_VISION_SHORTCUT_H_
